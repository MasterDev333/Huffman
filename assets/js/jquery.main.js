...
function initTab() {
	$('[data-tab]').on('mouseover', function () {
		$(this).closest('li').addClass('active').siblings('li.active').removeClass('active');
		var activeTabsName = $(this).data('tab');
		$('[data-tab-name="' + activeTabsName + '"]').each(function () {
			$(this).addClass('active').siblings('.tab-image.active').removeClass('active');
		});
		$(window).resize();
	});
...
function initStaffSlider() {
	$(".staff-slider").each(function () {
		...
		var swiper = new Swiper(this, {
			...
			autoHeight: true,
			navigation: {
				nextEl: $(self).closest('.staff-slider').find(".swiper-button-next").get(0),
				prevEl: $(self).closest('.staff-slider').find(".swiper-button-prev").get(0),
			},
			pagination: {
				el: $(self).closest('.staff-slider').find(".swiper-pagination").get(0),
				type: "fraction",
			},
			breakpoints: {
				1280: {
	...
	function enableSwiper() {
		$(".slider-mobile").each(function () {
			...
			mySwiper = new Swiper(this, {
				...
				spaceBetween: 2,
				navigation: {
					nextEl: $(self).closest('.slider-mobile').find(".swiper-button-next").get(0),
					prevEl: $(self).closest('.slider-mobile').find(".swiper-button-prev").get(0),
				},
				pagination: {
					el: $(self).closest('.slider-mobile').find(".swiper-pagination").get(0),
					type: "fraction",
				},
				breakpoints: {
					768: {
	...
	function enableSwiper() {
		$(".team-slider").each(function () {
			...
			mySwiper = new Swiper(this, {
				...
				spaceBetween: 2,
				navigation: {
					nextEl: $(self).closest('.team-slider').find(".swiper-button-next").get(0),
					prevEl: $(self).closest('.team-slider').find(".swiper-button-prev").get(0),
				},
				pagination: {
					el: $(self).closest('.team-slider').find(".swiper-pagination").get(0),
					type: "fraction",
				},
				breakpoints: {
					768: {
...
function initTeamTab() {
	$('[data-tabs]').on('click', function (e) {
		...
		$('[data-tabs-name="' + activeTabsName + '"]').each(function () {
			$(this).addClass('active').siblings('.swiper-slide.active').removeClass('active');
		});
		$(window).resize();
	});
	if (window.location.hash && $('a[href="' + window.location.hash + '"]').length) {
...
function initResultSlider() {
	$(".result-slider").each(function () {
		...
		var swiper = new Swiper(this, {
			...
			mousewheel: false,
			navigation: {
				nextEl: $(self).closest('.result-slider').find(".swiper-button-next").get(0),
				prevEl: $(self).closest('.result-slider').find(".swiper-button-prev").get(0),
			},
			pagination: {
				el: $(self).closest('.result-slider').find(".swiper-pagination").get(0),
				type: "fraction",
			},
			breakpoints: {
				1280: {
	...
	$(".results").each(function () {
		...
		var swiper = new Swiper(this, {
			...
			mousewheel: false,
			navigation: {
				nextEl: $(self).closest('.results').find(".swiper-button-next").get(0),
				prevEl: $(self).closest('.results').find(".swiper-button-prev").get(0),
			},
			pagination: {
				el: $(self).closest('.results').find(".swiper-pagination").get(0),
				type: "fraction",
			},
		});
	});
	$('.btn-more').on('click', function (e) {
		...
		$(this).closest('.result-card').find('.expanded').slideToggle();
	});
}
...
function initTestimonialSlider() {
	$(".testimonial-slider").each(function () {
		...
		var swiper = new Swiper(this, {
			...
			pagination: {
				el: $(self).closest('.testimonial-slider').find(".swiper-pagination").get(0),
				type: "fraction",
			},
		});
	});
